...
from Multimodal_transformer.Preprocessing_CNN.Preprocessing_utils.efficientface import LocalFeatureExtractor,InvertedResidual
from Multimodal_transformer.Preprocessing_CNN.Preprocessing_utils.modulator import Modulator
...
class EfficientFaceTemporal(nn.Module):
    ...
    def __init__(self, stages_repeats, stages_out_channels, num_classes=4, im_per_sample=25):
