...
def parse_opts():
    ...
    parser.add_argument('--video_file_path',type=str,help='define path for video path',default='')
    parser.add_argument('--audio_file_path',type=str,help='define path for audio path',default='')
